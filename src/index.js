...
const OraculumAddress = '3N5XNq7FMSGU5NmZbLFu8HkDY8EDYubTJwy';
...
document.querySelector(".js-invoke").addEventListener("click", async function () {
    try {
        ...
        // Call tellme function of wavesexplorer.com/tesnet/address/3N5XNq7FMSGU5NmZbLFu8HkDY8EDYubTJwy/script dApp
        // Generate an answer and write it to the dApp data storage

        try {
            await signer.invoke({
                dApp: OraculumAddress,
                call: {
                    function: "tellme",
        ...
        // Read an answer from dApp data storage
            ...
            let answer = await nodeInteraction.accountDataByKey(user.address+'_a',OraculumAddress,nodeUrl);
